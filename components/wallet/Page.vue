...
<template>
  ...
  <div>
    ...
    <div
      v-if="
        data['walletscrutiny-desktop'] ||
        data['walletscrutiny-android'] ||
        data['walletscrutiny-iphone']
      "
    >
      <div class="rounded-lg bg-gray-100 px-4 py-2 my-4">
        ...
        <div class="flex flex-wrap gap-2">
          <WalletScrutiny
            v-for="device of scrutiny"
            :device="device.device"
            :valore="data['walletscrutiny-' + device.device]"
            :icona="device.icona"
          />
        </div>
      </div>
