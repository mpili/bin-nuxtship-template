						...
						<div class="flex justify-center items-center">
							<div class="mx-auto">
								...
								<div class="relative flex flex-col text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-36">
									<div class="relative mx-4 mt-4 overflow-hidden text-gray-700 bg-white bg-clip-border rounded-xl h-28">
										<NuxtImg :src="`/img/l/${item.id}.jpg`"  class="object-cover w-full h-full" />
									</div>
									<div class="p-2 pt-0">
										<button
